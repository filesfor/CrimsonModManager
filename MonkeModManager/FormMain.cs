...
namespace MonkeModManager
{
    public partial class FormMain : Form
    {
        ...
        private void FormMain_Load(object sender, EventArgs e)
        {
            ...
            labelVersion.Text = "Crimson Mod Manager v" + version.Substring(0, version.Length - 2);
        ...
        {
#if !DEBUG
            var decodedMods = JSON.Parse(DownloadSite("https://raw.githubusercontent.com/filesfor/CrimsonModManager/main/modinfo.json"));
            var decodedGroups = JSON.Parse(DownloadSite("https://raw.githubusercontent.com/filesfor/CrimsonModManager/main/groupinfo.json"));
#else
        ...
        {
            Process.Start("https://discord.gg/5zjNDVsX63");
        }
        ...
        private string DownloadSite(string URL)
        {
            try
            {
                ...
                RQuest.Referer = "";
                RQuest.UserAgent = "Crimson-Mod-Manager";
                RQuest.Proxy = null;
#if DEBUG
